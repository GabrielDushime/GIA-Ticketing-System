...
<%@ page import="com.connection.User" %>
	...
	<form class="register_form form_login" action="Login.jsp" method="post">
		...
		<div class="row">
			...
			<div class="owl-carousel home_page_slider">
			  <div class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/1.jpg)">
			  	</div>
			  </div>
			  <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/2.jpg)">
			  	</div>
			  </div>
			  <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/6.jfif)">
			  	</div>
			  </div>
                              <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/4.jfif)">
			  	</div>
			  </div>
                              <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/7.jfif)">
			  	</div>
			  </div>
                              <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/8.jfif)">
			  	</div>
			  </div>
                              <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/9.jfif)">
			  	</div>
			  </div>
			  <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/5.jpg)">
			  	</div>
