	...
	<form class="register_form" style="max-width:400px;" action="<%= Helper.baseUrl %>TicketDisplay.jsp" method="post">
		<div class="rs_form_box">
			...
			<div class="form-group">
				...
				<select class="form-control" name="bus" id="from_where_select" >
				...
				for(Map.Entry<String, String> temp:coach.entrySet()){
					%>
					<option value="<%= temp.getValue() %>"><%= temp.getValue() %></option>
					<%
				}
				%>
				</select>
		...
		<div class="text-center">
			<div class="rs_btn_group">
				<button class="btn btn-default" type="submit">book ticket</button>
			</div>
		</div>
	</form>
</div>
